...
* If there are six authors, the format of MLA is as follows: <br />
{Surname1}, {Name1}, {Surname2}, {Name2}, {Surname3}, {Name3}, {Surname4}, {Name4}, {Surname5}, {Name5}, and {Surname6}, {Name6}. "{ArticleTitle}." {JournalName} {IssueNumber} ({YearOfPublication}): {PageFrom}-{PageTo}.<br />
...
* If there are five authors, the format of MLA is as follows: <br />
...
* If there are four authors, the format of MLA is as follows: <br />
...
* If there are three authors, the format of MLA is as follows: <br />
...
* If there are two authors, the format of MLA is as follows: <br />
{Surname1}, {Name1}, and {Surname2}, {Name2}. "{ArticleTitle}." {JournalName} {IssueNumber} ({YearOfPublication}): {PageFrom}-{PageTo}. <br />
...
* If there is one author, the format of MLA is as follows: <br />
{Surname1}, {Name1}. "{ArticleTitle}." {JournalName} {IssueNumber} ({YearOfPublication}): {PageFrom}-{PageTo}. <br />
